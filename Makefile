srcdir = /Users/daldegam/Desktop/php-5.6.14/ext/mssql
builddir = /Users/daldegam/Desktop/php-5.6.14/ext/mssql
top_srcdir = /Users/daldegam/Desktop/php-5.6.14/ext/mssql
top_builddir = /Users/daldegam/Desktop/php-5.6.14/ext/mssql
...
RE2C = exit 0;
AWK = awk
shared_objects_mssql = php_mssql.lo
PHP_PECL_EXTENSION = mssql
MSSQL_SHARED_LIBADD = -Wl,-rpath,/usr/local/lib -L/usr/local/lib -lsybdb
PHP_MODULES = $(phplibdir)/mssql.la
PHP_ZEND_EX =
...
prefix = /usr/local/Cellar/php56/5.6.14
phplibdir = /Users/daldegam/Desktop/php-5.6.14/ext/mssql/modules
...
EXTRA_LDFLAGS =
EXTRA_LIBS =
INCLUDES = -I/usr/local/Cellar/php56/5.6.14/include/php -I/usr/local/Cellar/php56/5.6.14/include/php/main -I/usr/local/Cellar/php56/5.6.14/include/php/TSRM -I/usr/local/Cellar/php56/5.6.14/include/php/Zend -I/usr/local/Cellar/php56/5.6.14/include/php/ext -I/usr/local/Cellar/php56/5.6.14/include/php/ext/date/lib -I/usr/local/include
LFLAGS =
LDFLAGS =
SHARED_LIBTOOL =
